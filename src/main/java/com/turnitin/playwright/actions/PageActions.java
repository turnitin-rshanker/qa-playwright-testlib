...
import com.turnitin.playwright.util.NavigationUrls;
...
final class PageActions {
  ...
  private void logResolvedNavigation(String pageUrl) {
    if (baseUrl == null || baseUrl.isBlank()) {
      log.info("Navigating: path={0}; BrowserContext will resolve it against its configured baseUrl {}",
   ...
   log.info(
        "Navigating: baseUrl={}, path={}, resolvedUrl={}",
