...
import dev.codex.playwright.actions.BulkInputException;
import dev.codex.playwright.actions.PlaywrightActions;
import dev.codex.playwright.actions.TextFieldInput;
...
public class Component {
  ...
  public Locator findLocator(LocatorRef locatorRef) {
    return requireRef(locatorRef).resolve(page);
  }
  ...
  public Locator findLocator(
    ...
    return requireRef(locatorRef).resolve(page, options);
  }
