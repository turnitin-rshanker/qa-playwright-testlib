...
public final class ActionsPage extends Base {
  ...
  public ActionsPage enterNameAndEnableUpdates(String value) {
    focus(NAME)
        .setValue(NAME, value)
        .press(NAME, "End")
        .check(UPDATES)
  ...
  public ActionsPage selectPriority(String label) {
    selectByLabel(PRIORITY, label);
    return this;
  }

  public ActionsPage save() {
